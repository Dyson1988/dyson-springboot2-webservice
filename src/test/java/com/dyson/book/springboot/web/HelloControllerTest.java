...
import com.dyson.book.springboot.config.auth.SecurityConfig;
...
public class HelloControllerTest {
    ...
    public void hello가_리턴된다() throws Exception {
        ...
        mvc.perform(get("/hello"))           //MockMvc를 통해 /hello 주소로 HTTP Get 요청을 한다.
                .andExpect(status().isOk())             //mvc.perform의 결과를 검증 200,404,500 등의 상탤르 검증(200만)
                .andExpect(content().string(hello));    //응답 본문의 내용을 검증 controller에서 "hello"를 리턴하기 때문
    }
