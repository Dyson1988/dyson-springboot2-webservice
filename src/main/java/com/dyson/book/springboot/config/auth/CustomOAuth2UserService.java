package com.dyson.book.springboot.config.auth;

import com.dyson.book.springboot.config.auth.dto.OAuthAttributes;
import com.dyson.book.springboot.config.auth.dto.SessionUser;
import com.dyson.book.springboot.domain.user.User;
import com.dyson.book.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    /*
        registrationId
            ...
            - 지금은 구글만 사용하는 불필요한 값이지만, 이후 네이버 로그인 연동 시에 네이버 로그인인지 구글 로그인인지
              구분하기 위해 사용한다.
